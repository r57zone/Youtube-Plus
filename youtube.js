...
if (node.parentNode.parentNode.childNodes[1].innerHTML.indexOf('http://convert2mp3.net/addon_call.php?url=')==-1)
node.parentNode.parentNode.childNodes[1].innerHTML=node.parentNode.parentNode.childNodes[1].innerHTML+'<div style="margin-top:3px;"><a target="_blank" href="http://convert2mp3.net/addon_call.php?url='+node.childNodes[1].href+'&format=mp3">Скачать аудио</a> <a target="_blank" href="http://ru.savefrom.net/#url='+node.childNodes[1].href+'">Скачать видео</a></div>';
}}}
addlinktofeed(); 
...
if (document.location.href.indexOf('watch?v=')!=-1 || document.location.href.indexOf('watch?feature=player_embedded&v=')!=-1) {
	
//Удаление плейлистов
if (document.location.href.indexOf('list=')!=-1) {
var video_id = window.location.search.split('v=')[1];
var ampersandPosition = video_id.indexOf('&');
if (ampersandPosition != -1) document.location.href='https://www.youtube.com/watch?v='+video_id.substring(0, ampersandPosition);
}	
